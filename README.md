...
* `clients.php` - View all clients and linked contacts  
* `contacts.php` - View all contacts  
* `contact_form.php` - Contact creation form  
* `index.php` - Homepage  
* `README.md` - This file  
...
* `unlink_contact.php` - Logic to unlink contact from a client  
* `client_contact_management_db.sql` - MySQL export of the database, imported from phpMyAdmin

# Database Setup  
Make sure to import the `client_contact_db.sql` file using phpMyAdmin.  
It includes all the necessary tables (`Client`, `Contact`) with relationships.
